...
class IngredientController {
    static getAllIngredients(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield ingredient_service_1.IngredientService.getAllIngredients(req.user.id);
                res.status(200).json({
                    data: response,
                });
            }
    ...
    static saveIngredient(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield ingredient_service_1.IngredientService.createIngredients(request, req.user.id);
                res.status(200).json({
                    data: response,
                });
            }
