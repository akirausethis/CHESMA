        ...
        <div className="backdrop-blur-xl bg-white/85 border border-white/60 shadow-2xl rounded-[32px] p-8 md:p-10">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={!agreement}
              className="w-full bg-gradient-to-r from-emerald-500 to-green-600 text-white font-bold py-3.5 rounded-2xl shadow-lg shadow-emerald-200 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
              Create Account
              <ArrowRight size={18} />
            </button>
